...
/// @nodoc
mixin _$RatingViewState {
  ApiStatus get status => throw _privateConstructorUsedError;

  @JsonKey(ignore: true)
  $RatingViewStateCopyWith<RatingViewState> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $RatingViewStateCopyWith<$Res> {
  factory $RatingViewStateCopyWith(
          RatingViewState value, $Res Function(RatingViewState) then) =
      _$RatingViewStateCopyWithImpl<$Res, RatingViewState>;
  @useResult
...
/// @nodoc
class _$RatingViewStateCopyWithImpl<$Res, $Val extends RatingViewState>
    implements $RatingViewStateCopyWith<$Res> {
  _$RatingViewStateCopyWithImpl(this._value, this._then);
...
class __$$ProductDetailStateImplCopyWithImpl<$Res>
    extends _$RatingViewStateCopyWithImpl<$Res, _$ProductDetailStateImpl>
...
class _$ProductDetailStateImpl extends _ProductDetailState
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'RatingViewState(status: $status)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'RatingViewState'))
...
abstract class _ProductDetailState extends RatingViewState {
